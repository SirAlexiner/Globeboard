...
func TestSupportedLanguagesGetNoKey(t *testing.T) {
	// Create a request to your endpoint with the GET method
	req, err := http.NewRequest("GET", Endpoints.RegistrationsSlash, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSupportedLanguagesGet(t *testing.T) {
	// Create a request to your endpoint with the GET method
	req, err := http.NewRequest("GET", Endpoints.RegistrationsSlash+"?token="+token+"", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSupportedLanguagesGetWrongKey(t *testing.T) {
	// Create a request to your endpoint with the GET method
	req, err := http.NewRequest("GET", Endpoints.RegistrationsSlash+"?token=c35c5742", nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSupportedLanguagesMethodNotAllowed(t *testing.T) {
	// Create a request to your endpoint with a method other than GET
	req, err := http.NewRequest("POST", Endpoints.RegistrationsSlash, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	req, err = http.NewRequest("PUT", Endpoints.RegistrationsSlash, nil)
	if err != nil {
		t.Fatal(err)
	}
